...
def send(client_socket, command):
    ...
    # Debug log for the command object before sending
    print("Final Command Object to Send:", command_dict)
...
def map_keys_to_buttons(bot_command):
    ...
    bot_command.player_buttons.reset()
...
def main():
    ...
    while (current_game_state is None) or (not current_game_state.is_round_over):
        ...
        # Use the AI model to predict moves
